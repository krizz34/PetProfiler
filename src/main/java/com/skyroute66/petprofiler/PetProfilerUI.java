...
public class PetProfilerUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PetProfileSolutionUI
     */
    ...
    private void catButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_catButtonActionPerformed
        ...
        // Task 2: create an instance of Cat instead of Pet
        Pet myCat = new Cat(getNameEntered(), getYearsEntered());
        
        String description = myCat.selfDescribe();
    ...
    private void dogButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dogButtonActionPerformed
        ...
        // create a new instance using the values:
        // Task 2: create an instance of Dog instead of Pet
        Pet myDog = new Dog(getNameEntered(), getYearsEntered());
        
        String description = myDog.selfDescribe();
        profileTextArea.setText(description);
    ...
    private void goldfishButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goldfishButtonActionPerformed
        ...
        // task 5: Step 5: change Pet to Goldfish to the constructor
        Pet myGoldfish = new Goldfish(getNameEntered(), getYearsEntered());
        
        String description = myGoldfish.selfDescribe();
        profileTextArea.setText(description);
